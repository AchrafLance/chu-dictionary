...
<a href="{{route('posts.all')}}"><span class="btn btn-5">show all</span> </a>
...
<div class="create-post">
    ...
    <form action="{{ route('dictionnaire') }}" method="post" class="post-form">
        @csrf
...
<div class="search-content">
    ...
    <div class="search-dropdown hidden">
        ...
        {{-- url('post/'.$item->id --}}
        <a class="post" href="{{ route('posts.viewPost', ['id'=>$item->id]) }}">
